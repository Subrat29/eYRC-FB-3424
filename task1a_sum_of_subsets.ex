defmodule Task1aSumOfSubsets do
  ...
  #Example call:
    if given 2d matrix is as follows:
      ...
      ...(1)>       ["na", 22, "na", "na", "na"]
      ...(1)>     ]
      iex(2)> Task1a_Sum_Of_Subsets.valid_sum(matrix_of_sum)
      [21, 12, 12, 17, 22]
  """
  ...
  def sum_of_all(array_of_digits, matrix_of_sum) do
    unique_list = Enum.uniq(valid_sum(matrix_of_sum))
    for n <- unique_list, do: sum_of_one(array_of_digits, n)
  end
end
